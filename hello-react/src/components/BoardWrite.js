...
class BoardWrite extends Component {
    render(){
        const city = [{
            city : '서울특별시',
            country : ["강남구","강동구","강북구","강서구","관악구","광진구","구로구","금천구","노원구","도봉구","동대문구","동작구","마포구","서대문구","성동구","성북구","송파구","양천구","영등포구","용산구","은평구","종로구","중구","중랑구"]
        },{
            city: '부산광역시',
            country : ["강서구","금정구","기장군","남구","동구","동래구","부산진구","북구","사상구","사하구","서구","수영구","연제구","영도구","중구","해운대구"]
        },{
            city : '대구광역시',
            country : ["남구","달서구","달성군","동구","북구","서구","중구"]
        }]
        
        "연수구","남동구","부평구","계양구","강화군","옹진군","미추홀구","광산구","유성구","대덕구","울주군","수원시","수원시 장안구","수원시 권선구","수원시 팔달구","수원시 영통구",
						...
						<div className="inner">
							<div className="centered pop_wrap">
                                ...
                                <dl>
                                    <dt>지역</dt>
                                    <dd>
                                        <select name="city1" title="시/도선택" className="select">
								    		<option value="">:: 시/도 ::</option>
                                            <option defaultValue="서울특별시" title="서울특별시">서울특별시</option>
